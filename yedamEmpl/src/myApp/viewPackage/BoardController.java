...
public class BoardController implements Initializable {
	...
	@FXML
	Button updateBtn, deleteBtn, addBtn, upBtn, downBtn;
...
//		tableView.getColumns().add(tcEdate);
	...
	public void upBtn(ActionEvent e) { // 위방향키
		
		tableView.getSelectionModel().select( tableView.getSelectionModel().getSelectedIndex() -1 );
		tableView.scrollTo(tableView.getSelectionModel().getSelectedIndex() -1 );
		
	}

	
	public void downBtn(ActionEvent e) { // 아래방향키
		tableView.getSelectionModel().select( tableView.getSelectionModel().getSelectedIndex() +1 );
		tableView.scrollTo(tableView.getSelectionModel().getSelectedIndex() +1 );
